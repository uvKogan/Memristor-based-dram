...
=== #strong[3.1.6 Simulation-Fidelity Audit: Where the Toolchain Could
Not Be Trusted - and How It Was Repaired]
...
== 3.2. #strong[Architectural Scaling & Memory Level Parallelism]
(Pareto Frontiers)
...
= References
<references>
#strong[\[1\]] M. Ahmad, \"NAND Flash\'s Reversal of Fortune Amid the AI
Boom,\" #emph[EE Times], Jan. 26, 2026. \[Online\]. Available:
#link("https://www.eetimes.com/nand-flashs-reversal-of-fortune-amid-the-ai-boom/")[#underline[https:\/\/www.eetimes.com/nand-flashs-reversal-of-fortune-amid-the-ai-boom/]].
\[Accessed: Apr. 25, 2026\].

#strong[\[2\]] A. J. Fleischer, \"How AI Broke the Memory Market,\"
#emph[Octopart Pulse], Mar. 13, 2026. \[Online\]. Available:
#link("https://octopart.com/pulse/p/how-ai-broke-memory-market")[#underline[https:\/\/octopart.com/pulse/p/how-ai-broke-memory-market]].
\[Accessed: Apr. 25, 2026\].

#strong[\[3\]] X. Dong et al., \"NVSim: A Circuit-Level Performance,
Energy, and Area Model for Emerging Nonvolatile Memory,\" #emph[IEEE
Trans. Comput.-Aided Design Integr. Circuits Syst.], vol. 31, no. 7, pp.
994-1007, July 2012.

#strong[\[4\]] M. Poremba, T. Zhang, and Y. Xie, \"NVMain 2.0: A
user-friendly memory simulator to model (non-)volatile memory systems,\"
IEEE Comput. Archit. Lett., vol. 14, no. 2, pp. 140-143, July-Dec. 2015.

#strong[\[5\]] International Roadmap for Devices and Systems (IRDS),
\"More Moore,\" 2024. \[Online\]. Available:
#link("https://irds.ieee.org/images/files/pdf/2024/2024IRDS_MM.pdf")[#underline[https:\/\/irds.ieee.org/images/files/pdf/2024/2024IRDS\_MM.pdf]].

#strong[\[6\]] L. R. Upton et al., \"EMBER: A 100 MHz, 0.86 mm2,
multiple-bits-per-cell RRAM macro in 40 nm CMOS with compact peripherals
and 1.0 pJ/bit read circuitry,\" in Proc. IEEE 49th Eur. Solid State
Circuits Conf. (ESSCIRC), Sep. 2023, pp. 469-472.

#strong[\[7\]] C. Matsui, A. Yamada, N. Misawa, and K. Takeuchi, \"ReRAM
resistance design of LRS and HRS for ultrahigh-capacity digital memory
and analog Computation-in-Memory,\" IEICE Trans. Fundamentals, vol.
E109.A, no. 3, pp. 596-603, Mar. 2026. DOI: 10.1587/transfun.2025VLP0011

#strong[\[8\]] C. Xue et al., \"16.1 A 22nm 4Mb 8b-Precision ReRAM
Computing-in-Memory Macro with 11.91 to 195.7TOPS/W for Tiny AI Edge
Devices,\" #emph[2021 IEEE International Solid-State Circuits Conference
(ISSCC)], San Francisco, CA, USA, 2021, pp. 245-247.

#strong[\[9\]] S. H. Jo et al., \"3D-stackable crossbar resistive memory
based on Field Assisted Superlinear Threshold (FAST) selector,\"
#emph[2014 IEEE International Electron Devices Meeting (IEDM)], San
Francisco, CA, USA, 2014, pp. 6.7.1-6.7.4.

#strong[\[10\]] JEDEC Solid State Technology Association, \"DDR5 SDRAM
Standard,\" JESD79-5D, Nov. 2025. \[Online\]. Available:
#link("https://www.jedec.org/standards-documents/docs/jesd79-5d")[#underline[https:\/\/www.jedec.org/standards-documents/docs/jesd79-5d]].

#strong[\[11\]] B. C. Lee, E. Ipek, O. Mutlu, and D. Burger,
\"Architecting phase change memory as a scalable dram alternative,\" in
#emph[Proc. 36th Annu. Int. Symp. Comput. Archit. (ISCA)], 2009, pp.
2-13.

#strong[\[12\]] A. Samajdar, J. M. Joseph, Y. Zhu, P. Whatmough, M.
Mattina, and T. Krishna, \"A Systematic Methodology for Characterizing
Scalability of DNN Accelerators Using SCALE-Sim,\" in #emph[Proc. IEEE
Int. Symp. Perform. Anal. Syst. Softw. (ISPASS)], 2020, pp. 58-68.

#strong[\[13\]] B. Q. Le et al., “Resistive RAM With Multiple Bits Per
Cell: Array-Level Demonstration of 3 Bits Per Cell,” #emph[IEEE Trans.
Electron Devices], vol. 66, no. 1, pp. 641–648, Jan. 2019.

#strong[\[14\]] H.-S. P. Wong et al., “Metal–Oxide RRAM,” #emph[Proc.
IEEE], vol. 100, no. 6, pp. 1951–1970, June 2012. DOI:
10.1109/JPROC.2012.2190369

#strong[\[15\]] M. Lanza et al., “Standards for the Characterization of
Endurance in Resistive Switching Devices,” #emph[ACS Nano], vol. 15, no.
11, pp. 17214–17231, Nov. 2021. DOI: 10.1021/acsnano.1c06980

#strong[\[16\]] Data Center Knowledge, “Data Center Hardware Refresh
Cutback by Microsoft – What’s Next?,” Aug. 25, 2022. \[Online\].
Available:
...
\[17\] TrendForce, \"Micron Races Ahead in 10nm-Class DRAM with 1γ DDR5
Samples Delivered to Intel & AMD,\" Feb. 26, 2025. \[Online\].
Available:
https:\/\/www.trendforce.com/news/2025/02/26/news-micron-races-ahead-in-10nm-class-dram-with-1γ-ddr5-samples-delivered-to-intel-amd/.
\[Accessed: Jul. 11, 2026\].

\[18\] J. Choe, \"Comparing DDR5 Memory From Micron, Samsung, SK
Hynix,\" EE Times, Feb. 15, 2022. \[Online\]. Available:
https:\/\/www.eetimes.com/comparing-ddr5-memory-from-micron-samsung-sk-hynix/.
\[Accessed: Jul. 12, 2026\].

\[19\] A. Shilov, \"Samsung Puts 3D DRAM on the Roadmap, Stacked DRAM to
Follow,\" Tom\'s Hardware, Apr. 3, 2024. \[Online\]. Available:
...
\[20\] J. Yang et al., \"A 14nm-FinFET 1Mb Embedded 1T1R RRAM with a
0.022µm² Cell Size Using Self-Adaptive Delayed Termination and
Multi-Cell Reference,\" in Proc. IEEE Int. Solid-State Circuits Conf.
(ISSCC), 2021. DOI: 10.1109/ISSCC42613.2021.9365945

\[21\] K. T. Malladi, F. A. Nothaft, K. Periyathambi, B. C. Lee, C.
Kozyrakis, and M. Horowitz, \"Towards Energy-Proportional Datacenter
Memory with Mobile DRAM,\" in Proc. 39th Annu. Int. Symp. Computer
Architecture (ISCA), 2012. DOI: 10.1109/ISCA.2012.6237004

\[22\] A. Gholami, Z. Yao, S. Kim, C. Hooper, M. W. Mahoney, and K.
Keutzer, \"AI and Memory Wall,\" IEEE Micro, vol. 44, no. 3, May/June
2024. DOI: 10.1109/MM.2024.3373763

\[23\] Tom\'s Hardware, \"Intel Kills Optane Memory Business Entirely,
Pays \$559 Million to Exit,\" Jul. 28, 2022. \[Online\]. Available:
https:\/\/www.tomshardware.com/news/intel-kills-optane-memory-business-for-good.
\[Accessed: Jul. 13, 2026\].

\[24\] TechInsights, \"Advanced TSMC 22ULL Embedded RRAM Chip
Unveiled.\" \[Online\]. Available:
https:\/\/www.techinsights.com/blog/advanced-tsmc-22ull-embedded-rram-chip-unveiled.
\[Accessed: Jul. 13, 2026\].

\[25\] Tom\'s Hardware, \"Neo Semiconductor\'s Revolutionary 3D X-DRAM
for AI Processors Has Passed Proof-of-Concept Validation,\" Apr. 24,
2026. \[Online\]. Available:
https:\/\/www.tomshardware.com/tech-industry/artificial-intelligence/neo-semiconductors-revolutionary-3d-x-dram-for-ai-processors-has-passed-proof-of-concept-validation-company-secures-funding-to-develop-next-gen-memory-hbm-alternative.
\[Accessed: Jul. 13, 2026\].

\[26\] N. Binkert et al., \"The gem5 Simulator,\" ACM SIGARCH Computer
Architecture News, vol. 39, no. 2, pp. 1-7, May 2011. DOI:
10.1145/2024716.2024718

\[27\] J. D. McCalpin, \"Memory Bandwidth and Machine Balance in Current
...
\[28\] Standard Performance Evaluation Corporation, \"SPEC CPU 2017
Benchmark Suite.\" \[Online\]. Available: https:\/\/www.spec.org/cpu2017/.
\[Accessed: Jul. 13, 2026\].

\[29\] Micron Technology, Inc., \"16Gb DDR5 SDRAM Addendum: MT60B4G4,
MT60B2G8, MT60B1G16, Die Revision A,\" Doc. No.
CCM005-0005-1684161373-30, Rev. D, Feb. 2023. \[Online\]. Available:
https:\/\/www.micron.com/products/memory/dram-components/ddr5-sdram/part-catalog

\[30\] SK hynix Inc., \"16Gb DDR5 SDRAM,\" datasheet. \[Online\].
Available (registration required):
https:\/\/product.skhynix.com/support/downloads.go
...
python3 3\_gen\_nvmain\_config.py \-\-freq 800

#strong[B.2: High-Cycle Batch Simulation] The master orchestration
...
python3 mbmm\_master.py \-\-cycles 66666667 \-\-trace
